...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return
     */
    public BaseViewHolder setStringImageResource(int viewId, String imageResId) {
        ImageView view = getView(viewId);
        ImageLoader.getInstance().displayImage(imageResId,view, ToolImage.getDefaultFailureOptions());
