...
public abstract class ToolImage {
    ...
    public static ImageLoader init(Context context) {
        ...
        // 获取到缓存的目录地址
        File cacheDir = StorageUtils.getOwnCacheDirectory(context, "vlooks/Cache");
...
//		.memoryCacheExtraOptions(480, 800)//缓存文件的最大长宽，默认屏幕宽高
     ...
     * 获取默认显示失败配置选项
     */
    public static DisplayImageOptions getDefaultFailureOptions() {

        DisplayImageOptions defaultOptions = new DisplayImageOptions.Builder()
                .showImageForEmptyUri(R.drawable.ima_file)
                .showImageOnFail(R.drawable.ima_file)
                .cacheInMemory(true)
                .cacheOnDisk(true)
                .bitmapConfig(Bitmap.Config.RGB_565)
                .build();
